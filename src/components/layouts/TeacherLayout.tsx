...
export function TeacherLayout() {
  ...
  const navItems = [
    { to: '/teacher', label: 'لوحة التحكم', icon: LayoutDashboard, exact: true },
    { to: '/teacher/exams', label: 'إدارة الامتحانات', icon: FileText },
    { to: '/teacher/exams/create', label: 'إنشاء امتحان', icon: Plus },
    { to: '/teacher/results', label: 'النتائج والإحصائيات', icon: BarChart },
    { to: '/teacher/top-students', label: 'الطلاب المتفوقون', icon: Award },
  ];
    ...
    <div className="flex flex-col h-full">
      <div className="p-6 border-b">
        <Link to="/" className="flex items-center gap-2">
          ...
          <div>
            <h2 className="font-bold text-lg">لوحة المعلم</h2>
        ...
        <header className="lg:hidden sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur">
          <div className="flex items-center justify-between p-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold">لوحة المعلم</span>
            </div>
            <Sheet>
